...
class Birds
{
    ...
    public function getSynonymesChresonyme(): ?string
    {
        return $this->synonymes_chresonyme;
    }

    public function setSynonymesChresonyme(?string $synonymes_chresonyme): self
    {
        $this->synonymes_chresonyme = $synonymes_chresonyme;
